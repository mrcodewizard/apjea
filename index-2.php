 ...
 <body> <div class="wrapper"> 
 	<?php include "includes/topbar.php";?> 
 		<header class="main-header">
			<div class="container-fluid  padding-0">
				<iframe src="https://www.google.com/maps/d/u/0/embed?mid=1qcH-1z4JVYZPDeVgQ1XtkcpXNHnUBuH_" width="100%" height="480"></iframe>
			</div>
		</header>
		...
		<div class="offer-section">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-5 bars-column">
						<div class="progress">
	...
	<script type="text/javascript">
		...
		// 	var total = $(this).find(".inner").attr("data-width");
		// 	if($(this).find(".inner").width<=total){
		// 		setInterval(function(){
		// 			// var width = $(".inner").attr("data-width");
		// 			width = width + 10;
